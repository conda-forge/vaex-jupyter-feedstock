...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3621&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vaex-jupyter-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vaex-jupyter` can be installed with `conda`:
...
```
mamba install vaex-jupyter
```

It is possible to list all of the versions of `vaex-jupyter` available on your platform with `conda`:
...
```
mamba search vaex-jupyter --channel conda-forge
```
...
mamba repoquery search vaex-jupyter --channel conda-forge

# List packages depending on `vaex-jupyter`:
mamba repoquery whoneeds vaex-jupyter --channel conda-forge

# List dependencies of `vaex-jupyter`:
mamba repoquery depends vaex-jupyter --channel conda-forge
```
